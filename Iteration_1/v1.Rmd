...
# building the model
# training model 3
lmModel_3 <- lm(max_critical_power_60m ~ . , data = train_3)
# Printing the model object
print(lmModel_3)
# Checking model statistics
summary(lmModel_3)
...
#perform weighted least squares regression
wls_model_2 <- lm(max_critical_power_60m ~ . , data = train_3, weights=wt_2)
...
# need to exclude 
lr_data_vif <- subset(lr_data_sig_3, select = -c(max_critical_power_60m))
vif_func(lr_data_sig_3[,1:4])

# easier method to compute VIF
